...
def mover_jugador(laberinto, direccion, jugador_fila, jugador_columna):
    ...
    if direccion == "t" and jugador_fila > 0 and laberinto[jugador_fila - 1][jugador_columna] != pared:
        nueva_fila -= 1
    elif direccion == "g" and jugador_fila < filas - 1 and laberinto[jugador_fila + 1][jugador_columna] != pared:
        nueva_fila += 1
    elif direccion == "f" and jugador_columna > 0 and laberinto[jugador_fila][jugador_columna - 1] != pared:
        nueva_columna -= 1
